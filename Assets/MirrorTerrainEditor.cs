...
public class MirrorTerrainEditor : Editor {
	...
	public override void OnInspectorGUI() {
		...
		if (GUILayout.Button("Mirror X-axis")) {
			lastHeightMap = terComponent.terrainData.GetHeights(0,0,terComponent.terrainData.heightmapWidth,terComponent.terrainData.heightmapHeight);
			
			int xLen = terComponent.terrainData.heightmapWidth;
			int yLen = (int) (terComponent.terrainData.heightmapHeight/2f);
		...
		if (GUILayout.Button("Mirror Y-axis")) {
			...
			int xLen = (int) (terComponent.terrainData.heightmapWidth/2f);
			int yLen = terComponent.terrainData.heightmapHeight;
